...
- (void)createPageControlView
{
    ...
    self.pageControl.currentPageIndicatorTintColor = textOrangeColor;
...
- (void)setPageControlColor:(UIColor *)pageControlColor {
    ...
    self.pageControl.currentPageIndicatorTintColor = pageControlColor;
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        NSString *imageStr = self.imageUrlArray[imageIndex];
        if ([imageStr containsString:@"http"]) {
            cell.imageURL = self.imageUrlArray[imageIndex];
        } else {
            cell.imageURL = UrlWithIconStr(self.imageUrlArray[imageIndex]);
        }
        
    }
    cell.titleName = self.titleArray[imageIndex];
...
//    if (_cyclePlayingClicekBlock) {
//        NSLog(@"%ld",indexPath.item);
//        if (!_modelArray) return;
//        _cyclePlayingClicekBlock(_modelArray[indexPath.item % _modelArray.count]);
//    }
