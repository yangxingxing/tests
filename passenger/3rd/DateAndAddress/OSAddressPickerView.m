...
{
    // 弹出的整个视图
    _wholeView = [[UIView alloc] initWithFrame:CGRectMake(0, ScreenHeight, ScreenWidth, 280)];
    _wholeView.backgroundColor = textLightGrayColor;
    [_wholeView addTopLineWithBorderColor:textLightGrayColor borderWidth:UILineBorderWidth];
    [self addSubview:_wholeView];
    
    // 头部按钮视图
    _topView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, 40)];
    _topView.backgroundColor = textWhiteColor;
...
- (void)showBottomView
{
    [UIView animateWithDuration:0.5 animations:^
     {
         _wholeView.frame = CGRectMake(0, ScreenHeight-280, ScreenWidth, 280);
...
- (void)hiddenBottomView
{
    [UIView animateWithDuration:0.5 animations:^
     {
         _wholeView.frame = CGRectMake(0, ScreenHeight, ScreenWidth, 280);
